...
func _apply_whatajong_ui() -> void:
	...
	WhatajongUI.apply_display_font(start_options_title)
	WhatajongUI.apply_display_font(seed_label)
	WhatajongUI.apply_display_font(seed_input)
	...
	WhatajongUI.apply_display_font(music_select_label)
	WhatajongUI.apply_display_font(music_option)
	...
	WhatajongUI.tint_body_text(music_select_label)
	WhatajongUI.tint_body_text(save_status_label)
